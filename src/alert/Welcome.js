...
const welcomeText = {
  ...
  "tab4": {
	  "welcome1": <div>Heavy industry energy consumption.</div>,
  ...
  "tab5": {
	  "welcome1": <div>Other sectors energy consumption.</div>,
  ...
  "tab7": {
	  "welcome1": <div>Transport sector energy consumption.</div>,
